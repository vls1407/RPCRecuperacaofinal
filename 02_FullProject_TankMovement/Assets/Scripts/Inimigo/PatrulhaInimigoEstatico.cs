...
public class PatrulhaInimigoEstatico : AIBehaviour
{
    ...
    {
        float angle = Vector2.Angle(tank.miraTorreta.transform.right, randomDirection);
        ...
        else
        {
            if (currentPatrolDelay > 0) 
                ...
                tank.HandleTurretMovement((Vector2)tank.miraTorreta.transform.position + randomDirection);
